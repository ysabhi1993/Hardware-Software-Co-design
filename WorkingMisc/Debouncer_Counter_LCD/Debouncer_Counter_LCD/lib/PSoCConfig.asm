...
export LoadConfig_debouncer_counter_lcd
export _LoadConfig_debouncer_counter_lcd
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_debouncer_counter_lcd
	lcall	LoadConfigTBL_debouncer_counter_lcd_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration debouncer_counter_lcd
;
;    Load configuration registers for debouncer_counter_lcd.
...
;               CUR_PP
;
_LoadConfig_debouncer_counter_lcd:
 LoadConfig_debouncer_counter_lcd:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_debouncer_counter_lcd_Bank0
    mov     X, <LoadConfigTBL_debouncer_counter_lcd_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_debouncer_counter_lcd_Bank1
    mov     X, <LoadConfigTBL_debouncer_counter_lcd_Bank1
