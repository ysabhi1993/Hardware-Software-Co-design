...
export LoadConfigTBL_debouncer_counter_lcd_Bank1
export LoadConfigTBL_debouncer_counter_lcd_Bank0
export LoadConfigTBL_debouncer_counter_lcd_Ordered
AREA lit(rom, rel)
LoadConfigTBL_debouncer_counter_lcd_Bank0:
;  Instance name LCD, User Module LCD
;  Instance name Timer16_sec, User Module Timer16
;       Instance name Timer16_sec, Block Name TIMER16_LSB(DBB00)
	db		23h, 00h		;Timer16_sec_CONTROL_LSB_REG(DBB00CR0)
	db		21h, 6eh		;Timer16_sec_PERIOD_LSB_REG(DBB00DR1)
	db		22h, 00h		;Timer16_sec_COMPARE_LSB_REG(DBB00DR2)
;       Instance name Timer16_sec, Block Name TIMER16_MSB(DBB01)
	db		27h, 04h		;Timer16_sec_CONTROL_MSB_REG(DBB01CR0)
	db		25h, 01h		;Timer16_sec_PERIOD_MSB_REG(DBB01DR1)
	db		26h, 00h		;Timer16_sec_COMPARE_MSB_REG(DBB01DR2)
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_debouncer_counter_lcd_Bank1:
;  Instance name LCD, User Module LCD
;  Instance name Timer16_sec, User Module Timer16
;       Instance name Timer16_sec, Block Name TIMER16_LSB(DBB00)
	db		20h, 10h		;Timer16_sec_FUNC_LSB_REG(DBB00FN)
	db		21h, 01h		;Timer16_sec_INPUT_LSB_REG(DBB00IN)
	db		22h, 40h		;Timer16_sec_OUTPUT_LSB_REG(DBB00OU)
;       Instance name Timer16_sec, Block Name TIMER16_MSB(DBB01)
	db		24h, 30h		;Timer16_sec_FUNC_MSB_REG(DBB01FN)
	db		25h, 31h		;Timer16_sec_INPUT_MSB_REG(DBB01IN)
	db		26h, 40h		;Timer16_sec_OUTPUT_MSB_REG(DBB01OU)
...
LoadConfigTBL_debouncer_counter_lcd_Ordered:
