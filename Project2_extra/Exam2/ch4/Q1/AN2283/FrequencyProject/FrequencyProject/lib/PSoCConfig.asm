...
export LoadConfig_frequencyproject
export _LoadConfig_frequencyproject
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_frequencyproject
...
;---------------------------------------------------------------------------
; Load Configuration frequencyproject
;
;    Load configuration registers for frequencyproject.
...
;               CUR_PP
;
_LoadConfig_frequencyproject:
 LoadConfig_frequencyproject:
    RAM_PROLOGUE RAM_USE_CLASS_4
    lcall   LoadConfigTBL_frequencyproject            ; Call load config table routine
