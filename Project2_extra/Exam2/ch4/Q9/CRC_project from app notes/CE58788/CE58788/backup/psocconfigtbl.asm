...
export LoadConfigTBL_example_crc_spim_Bank1
export LoadConfigTBL_example_crc_spim_Bank0
export LoadConfigTBL_example_crc_spim_Ordered
AREA lit(rom, rel)
LoadConfigTBL_example_crc_spim_Bank0:
;  Instance name CRC16, User Module CRC16
;       Instance name CRC16, Block Name CRC16_LSB(DBB00)
	db		23h, 00h		;CRC16_CONTROL_LSB_REG (DBB00CR0)
	db		21h, 00h		;CRC16_POLY_LSB_REG    (DBB00DR1)
	db		22h, 00h		;CRC16_SEED_LSB_REG    (DBB00DR2)
;       Instance name CRC16, Block Name CRC16_MSB(DBB01)
	db		27h, 00h		;CRC16_CONTROL_MSB_REG (DBB01CR0)
	db		25h, 00h		;CRC16_POLY_MSB_REG    (DBB01DR1)
	db		26h, 00h		;CRC16_SEED_MSB_REG    (DBB01DR2)
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_example_crc_spim_Bank1:
;  Instance name CRC16, User Module CRC16
;       Instance name CRC16, Block Name CRC16_LSB(DBB00)
	db		20h, 02h		;CRC16_FUNC_LSB_REG    (DBB00FN)
	db		21h, 98h		;CRC16_INPUT_LSB_REG   (DBB00IN)
	db		22h, 40h		;CRC16_OUTPUT_LSB_REG  (DBB00OU)
;       Instance name CRC16, Block Name CRC16_MSB(DBB01)
	db		24h, 22h		;CRC16_FUNC_MSB_REG    (DBB01FN)
	db		25h, 38h		;CRC16_INPUT_MSB_REG   (DBB01IN)
	db		26h, 40h		;CRC16_OUTPUT_MSB_REG  (DBB01OU)
;  Instance name LCD, User Module LCD
;  Instance name SPIM, User Module SPIM
;       Instance name SPIM, Block Name SPIM(DCB02)
	db		28h, 16h		;SPIM_FUNCTION_REG (DCB02FN)
	db		29h, 05h		;SPIM_INPUT_REG    (DCB02IN)
	db		2ah, 65h		;SPIM_OUTPUT_REG   (DCB02OU)
...
LoadConfigTBL_example_crc_spim_Ordered:
