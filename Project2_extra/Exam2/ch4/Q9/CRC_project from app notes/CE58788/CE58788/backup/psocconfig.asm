...
export LoadConfig_example_crc_spim
export _LoadConfig_example_crc_spim
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_example_crc_spim
	lcall	LoadConfigTBL_example_crc_spim_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration example_crc_spim
;
;    Load configuration registers for example_crc_spim.
...
;               CUR_PP
;
_LoadConfig_example_crc_spim:
 LoadConfig_example_crc_spim:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_example_crc_spim_Bank0
    mov     X, <LoadConfigTBL_example_crc_spim_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_example_crc_spim_Bank1
    mov     X, <LoadConfigTBL_example_crc_spim_Bank1
