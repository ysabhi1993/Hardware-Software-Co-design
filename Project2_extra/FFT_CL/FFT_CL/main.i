...
#line 20 "F:\HARDWA~1\Project2\FFT_CL\FFT_CL\lib\E2PROM_1.h"
#pragma fastcall16 E2PROM_1_Start 
#pragma fastcall16 E2PROM_1_Stop 
#pragma fastcall16 E2PROM_1_bE2Write 
#pragma fastcall16 E2PROM_1_E2Read 
...
#line 6 "C:\PROGRA~2\Cypress\PSOCDE~1\5.4\Common\CYPRES~1\tools\include\assert.h"
...
#line 23 "C:\PROGRA~2\Cypress\PSOCDE~1\5.4\Common\CYPRES~1\tools\include\CY8C29~1\flashblock.h"
...
#line 19 "C:\PROGRA~2\Cypress\PSOCDE~1\5.4\Common\CYPRES~1\tools\include\CY8C29~1\E2PROMLIB.h"
#pragma fastcall16 bE2Write 
...
#line 21 "F:\HARDWA~1\Project2\FFT_CL\FFT_CL\main.c"
typedef float real;
...
void fft(complex *v, int n,complex *tmp )
{
 ...
 w.Re = cosf(2*3.14159265358979323846264338327950288*m/(double)n);
 w.Im = -sinf(2*3.14159265358979323846264338327950288*m/(double)n);
...
#pragma abs_address:0x0
 complex v[(1<<8)], v1[(1<<8)], scratch[(1<<8)];
...
int main(void)
{
 ...
 for(k=0; k<(1<<8); k++) {
 v[k].Re = 0.125*cosf(2*3.14159265358979323846264338327950288*k/(double)(1<<8));
 v[k].Im = 0.125*sinf(2*3.14159265358979323846264338327950288*k/(double)(1<<8));
 v1[k].Re = 0.3*cosf(2*3.14159265358979323846264338327950288*k/(double)(1<<8));
 v1[k].Im = -0.3*sinf(2*3.14159265358979323846264338327950288*k/(double)(1<<8));
 }
