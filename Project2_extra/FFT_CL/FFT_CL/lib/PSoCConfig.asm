...
export LoadConfig_fft_cl
export _LoadConfig_fft_cl
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_fft_cl
	lcall	LoadConfigTBL_fft_cl_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration fft_cl
;
;    Load configuration registers for fft_cl.
...
_LoadConfig_fft_cl:
 LoadConfig_fft_cl:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_fft_cl_Bank0
    mov     X, <LoadConfigTBL_fft_cl_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_fft_cl_Bank1
    mov     X, <LoadConfigTBL_fft_cl_Bank1
