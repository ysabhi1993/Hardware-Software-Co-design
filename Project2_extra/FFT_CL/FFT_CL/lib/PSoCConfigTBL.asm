...
export LoadConfigTBL_fft_cl_Bank1
export LoadConfigTBL_fft_cl_Bank0
export LoadConfigTBL_fft_cl_Ordered
AREA lit(rom, rel)
LoadConfigTBL_fft_cl_Bank0:
