...
// FFT parameters
#define N_points 8              //number of points				
#define exponent log(8)/log(2)  //log2(N_points); for N_points=64 -> exponent=6
...
double save_data_re[N_points]={0};
double save_data_imm[N_points]={0};
