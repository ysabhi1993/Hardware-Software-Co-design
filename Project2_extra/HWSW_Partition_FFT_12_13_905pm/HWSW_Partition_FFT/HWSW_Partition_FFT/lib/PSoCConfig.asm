...
export LoadConfig_hwsw_partition_fft
export _LoadConfig_hwsw_partition_fft
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_hwsw_partition_fft
	lcall	LoadConfigTBL_hwsw_partition_fft_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration hwsw_partition_fft
;
;    Load configuration registers for hwsw_partition_fft.
...
;               CUR_PP
;
_LoadConfig_hwsw_partition_fft:
 LoadConfig_hwsw_partition_fft:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_hwsw_partition_fft_Bank0
    mov     X, <LoadConfigTBL_hwsw_partition_fft_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_hwsw_partition_fft_Bank1
    mov     X, <LoadConfigTBL_hwsw_partition_fft_Bank1
