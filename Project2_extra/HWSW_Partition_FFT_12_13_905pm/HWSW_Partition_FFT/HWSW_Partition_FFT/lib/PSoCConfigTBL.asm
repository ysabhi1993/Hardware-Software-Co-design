...
export LoadConfigTBL_hwsw_partition_fft_Bank1
export LoadConfigTBL_hwsw_partition_fft_Bank0
export LoadConfigTBL_hwsw_partition_fft_Ordered
AREA lit(rom, rel)
LoadConfigTBL_hwsw_partition_fft_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_hwsw_partition_fft_Bank1:
;  Instance name LCD_1, User Module LCD
...
LoadConfigTBL_hwsw_partition_fft_Ordered:
