...
export LoadConfig_proj1_mem
export _LoadConfig_proj1_mem
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_proj1_mem
	lcall	LoadConfigTBL_proj1_mem_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration proj1_mem
;
;    Load configuration registers for proj1_mem.
...
;               CUR_PP
;
_LoadConfig_proj1_mem:
 LoadConfig_proj1_mem:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_proj1_mem_Bank0
    mov     X, <LoadConfigTBL_proj1_mem_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_proj1_mem_Bank1
    mov     X, <LoadConfigTBL_proj1_mem_Bank1
