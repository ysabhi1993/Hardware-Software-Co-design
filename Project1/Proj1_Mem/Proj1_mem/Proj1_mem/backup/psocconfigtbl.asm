...
export LoadConfigTBL_proj1_mem_Bank1
export LoadConfigTBL_proj1_mem_Bank0
export LoadConfigTBL_proj1_mem_Ordered
AREA lit(rom, rel)
LoadConfigTBL_proj1_mem_Bank0:
...
LoadConfigTBL_proj1_mem_Ordered:
