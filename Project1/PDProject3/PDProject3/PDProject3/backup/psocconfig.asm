...
export LoadConfig_pdproject3
export _LoadConfig_pdproject3
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_pdproject3
	lcall	LoadConfigTBL_pdproject3_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration pdproject3
;
;    Load configuration registers for pdproject3.
...
;               CUR_PP
;
_LoadConfig_pdproject3:
 LoadConfig_pdproject3:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_pdproject3_Bank0
    mov     X, <LoadConfigTBL_pdproject3_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_pdproject3_Bank1
    mov     X, <LoadConfigTBL_pdproject3_Bank1
