...
export LoadConfigTBL_pdproject3_Bank1
export LoadConfigTBL_pdproject3_Bank0
export LoadConfigTBL_pdproject3_Ordered
AREA lit(rom, rel)
LoadConfigTBL_pdproject3_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_pdproject3_Bank1:
;  Instance name LCD_1, User Module LCD
...
LoadConfigTBL_pdproject3_Ordered:
