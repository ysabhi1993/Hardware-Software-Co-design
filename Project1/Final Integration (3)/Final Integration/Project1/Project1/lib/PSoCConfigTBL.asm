...
;       Instance name DUALADC_1, Block Name CNT1(DCB22)
	db		4bh, 00h		;DUALADC_1_bCounter1_CR0(DCB22CR0)
	db		49h, 00h		;DUALADC_1_bPeriod1(DCB22DR1)
	db		4ah, 00h		;DUALADC_1_bCompare1(DCB22DR2)
...
;       Instance name DUALADC_1, Block Name PWM16_LSB(DBB20)
	db		43h, 00h		;DUALADC_1_fPWM_LSB_CR0(DBB20CR0)
	db		41h, 00h		;DUALADC_1_bPWM_Period_LSB(DBB20DR1)
	db		42h, 00h		;DUALADC_1_bPWM_IntTime_LSB(DBB20DR2)
;       Instance name DUALADC_1, Block Name PWM16_MSB(DBB21)
	db		47h, 00h		;DUALADC_1_fPWM_MSB_CR0(DBB21CR0)
	db		45h, 00h		;DUALADC_1_bPWM_Period_MSB(DBB21DR1)
	db		46h, 00h		;DUALADC_1_bPWM_IntTime_MSB(DBB21DR2)
...
;  Global Register values Bank 0
	...
	db		e7h, 28h		; DecimatorControl_1 register (DEC_CR1)
...
;       Instance name DUALADC_1, Block Name ADC2(ASD22)
;       Instance name DUALADC_1, Block Name CNT1(DCB22)
	db		48h, 21h		;DUALADC_1_fCounter1FN(DCB22FN)
	db		49h, 45h		;DUALADC_1_fCounter1SL(DCB22IN)
	db		4ah, 40h		;DUALADC_1_fCounter1OS(DCB22OU)
;       Instance name DUALADC_1, Block Name CNT2(DCB23)
	db		4ch, 21h		;DUALADC_1_fCounter2FN(DCB23FN)
	db		4dh, 65h		;DUALADC_1_fCounter2SL(DCB23IN)
	db		4eh, 40h		;DUALADC_1_fCounter2OS(DCB23OU)
;       Instance name DUALADC_1, Block Name PWM16_LSB(DBB20)
	db		40h, 01h		;DUALADC_1_bfPWM_LSB_FN(DBB20FN)
	db		41h, 15h		;DUALADC_1_(DBA20IN)
	db		42h, 40h		;DUALADC_1_(DBA20OU)
;       Instance name DUALADC_1, Block Name PWM16_MSB(DBB21)
	db		44h, 21h		;DUALADC_1_bfPWM_MSB_FN(DBB21FN)
	db		45h, 35h		;DUALADC_1_(DBB21IN)
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[0ah], 80h		; Port_2_IntCtrl_0 register (PRT2IC0)
